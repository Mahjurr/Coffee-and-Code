...
class UNITSPresenter {
  void onCalculateClicked(String hourString, String minuteString,
      String sleepMinuteString, String sleepHourString) {}

  void onOptionChanged(int value,
      {required String sleepMinuteString, required String sleepHourString}) {}
...
class BasicPresenter implements UNITSPresenter {
  ...
  void onCalculateClicked(String hourString, String minuteString,
    ...
    temp = calculator(hour, minute, sleepHour, sleepMinute, _viewModel.unitType,
...
class MediaPresenter implements MEDIAPresenter {
  MEDIAViewModel _viewModel = MEDIAViewModel();
  //MEDIAView _view = MEDIAView();
