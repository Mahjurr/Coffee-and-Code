...
class UNITSViewModel {
  ...
  int get value =>
      _unitType == UnitType.WAKE ? 0 : 1; //Set unit type - 1 is KPG
  set value(int value) {
    if (value == 0) {
  ...
  int get valueTime =>
      _unitTypeTime == UnitType.AM ? 0 : 1; //Set unit type - 1 is KPG
  ...
  String get sleepMinuteInString =>
      sleepMinute != null ? sleepMinute.toString() : '';
